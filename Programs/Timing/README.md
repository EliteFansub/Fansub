For windows, extract `scxvid.exe` from [SCXvid/scxvid_exe_file.zip](https://github.com/EliteFansubBR/Fansub/blob/main/Programs/Timing/SCXvid/scxvid_exe_file.zip) and put in `SCXvid` folder
